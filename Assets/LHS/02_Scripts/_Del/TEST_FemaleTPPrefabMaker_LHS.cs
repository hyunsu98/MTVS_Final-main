...
public class TEST_FemaleTPPrefabMaker_LHS : MonoBehaviour
    ...
    // 살짝 동적으로 버튼에 기능을 넣어보자!!-------------------
    public Button[] btn_Hat;
    //-------------------------------------------------------

    // 몇번째 인지 알기 위한 변수
    //-----------------------------------------------------
    public int nextBtnNum_Hat;
    public int prevBtnNum_Hat;

    public int indexNum_Feet;
    //public int indexNum_Hair;
    //public int indexNum_Glasses;
    //-----------------------------------------------------
    ...
    void Start()
    {
        ...
        // 동적으로 버튼 넣기 _ Hat -------------------------------
        //btn_Hat[0].onClick.AddListener(Prevhat);
        //btn_Hat[1].onClick.AddListener(Nexthat);
        //--------------------------------------------------------
