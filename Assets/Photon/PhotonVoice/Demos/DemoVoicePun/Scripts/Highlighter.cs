...
namespace ExitGames.Demos.DemoPunVoice
{
    ...
    public class Highlighter : MonoBehaviour
    {
        ...
        [SerializeField]
        private Image recorderPulsingone;
        [SerializeField]
        private Image recorderPulsingtwo;

        [SerializeField]
        private Image speakerSprite;

        [SerializeField]
        private Image speakerPulsingone;
        [SerializeField]
        private Image speakerPulsingtwo;
        ...
        private void Update()
        {
            ...
            this.recorderPulsingone.enabled = this.photonVoiceView.IsRecording;
            this.recorderPulsingtwo.enabled = this.photonVoiceView.IsRecording;


            //this.speakerSprite.enabled = this.photonVoiceView.IsSpeaking;
            this.speakerPulsingone.enabled = this.photonVoiceView.IsSpeaking;
            this.speakerPulsingtwo.enabled = this.photonVoiceView.IsSpeaking;
